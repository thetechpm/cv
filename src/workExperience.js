const work = [{
    ...
    title: "Prinicipal PM Manager, Azure Resource Manager / Control Plane",
    timeperiod: "2016 - present",
    link: "https://azure.microsoft.com/features/resource-manager/",
    logoSrc: "media/microsoft.svg",
    details: [{primary: "Led the PM team supporting the common operations/actions/attributes for Azure resources to ensure Azure customers can have a consistent, intuitive, and capable resource experience through Azure Resource Manager's APIs, spanning hundreds of different Azure services", secondary: ["Led strategy, product portfolio development, customer adoption/success, key priorities, and service fundamentals for a team of product managers, technical program managers, and engineers working on Azure's centralized core capabilities", "Drove our engineering planning through backlog review and prioritization, making decisions on scopes for new and on-going work, release schedule and phasing, review and sign-off on design approach, product behaviors, and constraints/trade-offs"]},{primary:"Partnered with teams across the company to drive the vision and delivery of key functionality for the Azure control plane (Azure Resource Manager)", secondary:["Performed extensive user research from ambiguous idea to product design", "Led architecture discussions for new type-agnostic platform functionality", "Evolved the Azure resource provider contract, enforcing compliance and consistency while analyzing the impact and risks that new features could introduce", "Coordinated feature integrations across key cloud governance services such as Azure Policies, Azure Resource Graph, and Azure Management Groups"]}, {primary: "Presented products at technical conferences across the globe", secondary:["Microsoft Ignite (2016, 2017, 2018, 2019), the PowerShell 10-year anniversary, the PowerShell Summit (2017, 2018), and the Midwest Management Summit (2018)"]}]
},
{
